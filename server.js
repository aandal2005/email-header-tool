...
const User = require('./models/User'); // ⬅️ Make sure this file exists
const app = express();
...
// MongoDB connection
mongoose.connect('mongodb+srv://aandal:<password>@emailheadercluster.e2ir8k8.mongodb.net/emailAnalyzer?retryWrites=true&w=majority&appName=EmailHeaderCluster', {
